...
export const NOVA_PID_FILE = join(NOVA_HOME, 'nova.pid');
export const NOVA_SOCK_FILE = join(NOVA_HOME, 'nova.sock');
export const NOVA_LOG_DIR = join(NOVA_HOME, 'logs');
export const NOVA_DB_FILE = join(NOVA_HOME, 'nova.db');
export const NOVA_PLUGIN_DIR = join(NOVA_HOME, 'plugins');
export const NOVA_DAEMON_LOG = join(NOVA_LOG_DIR, 'nova-daemon.log');
export const NOVA_DAEMON_ERROR_LOG = join(NOVA_LOG_DIR, 'nova-daemon-error.log');
